...
const SELECTS = [
  { id: '1', name: 'All layers' },
  { id: '2', name: 'Isolated layers' },
];
...
function Layer() {
  ...
  const [select, setSelect] = useState('All layers');
  ...
  return (
    <section className="">
      <header className="flex justify-between items-center py-3 px-4 border-b-[#d0d0d7] border-b">
        <div>
          <h1 className="text-2xl font-semibold first-letter:capitalize">Layer</h1>
